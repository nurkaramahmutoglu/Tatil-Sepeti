...
# Case 2 : Tatil arama alanında bölge adını boş bırakması ve uyarı mesajı alması
...
class TestOtelAraİslemi(): 
    ...
    def test_otelaraislemi(self):
        ...
        WebDriverWait(self.driver, 5).until(EC.visibility_of_element_located((By.ID, "bolge"))).send_keys()
